...
export const headerRow = {
  ...
  cells: [
    { type: "header", text: `` },
    { type: "chevron", text: `hash`, isExpanded: false, hasChildren: true, groupId: 100 },
  ],
};
...
export const rows = () => [
  {
    ...
    cells: [
      ...
      {
        type: "chevron",
        text: "e989109363ec42610966f85fe9b065e6017058f7",
        parentId: "header",
        hasChildren: false,
      },
    ],
  },
  {
    ...
    cells: [
      { type: "chevron", text: "2", parentId: 100, hasChildren: false },
