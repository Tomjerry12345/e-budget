...
export const type4 = [
  ...
  { columnId: "jan", width: COL_WIDTH },
  { columnId: "jan_sd", width: COL_WIDTH },
  { columnId: "feb", width: COL_WIDTH },
  { columnId: "feb_sd", width: COL_WIDTH },
  { columnId: "mar", width: COL_WIDTH },
  { columnId: "mar_sd", width: COL_WIDTH },
  { columnId: "apr", width: COL_WIDTH },
  { columnId: "apr_sd", width: COL_WIDTH },
  { columnId: "mei", width: COL_WIDTH },
  { columnId: "mei_sd", width: COL_WIDTH },
  { columnId: "jun", width: COL_WIDTH },
  { columnId: "jun_sd", width: COL_WIDTH },
  { columnId: "jul", width: COL_WIDTH },
  { columnId: "jul_sd", width: COL_WIDTH },
  { columnId: "agu", width: COL_WIDTH },
  { columnId: "agu_sd", width: COL_WIDTH },
  { columnId: "sep", width: COL_WIDTH },
  { columnId: "sep_sd", width: COL_WIDTH },
  { columnId: "okt", width: COL_WIDTH },
  { columnId: "okt_sd", width: COL_WIDTH },
  { columnId: "nov", width: COL_WIDTH },
  { columnId: "nov_sd", width: COL_WIDTH },
  { columnId: "des", width: COL_WIDTH },
  { columnId: "des_sd", width: COL_WIDTH },
