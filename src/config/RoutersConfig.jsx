...
import FasilitasKreditPage from "pages/main/others/input/fasilitas-kredit/FasilitasKreditPage";
      ...
      <Routes>
        ...
        <Route path="/main" element={<MainPage />}>
          ...
          <Route path="capex">
            ...
            <Route path="summary/harga-jual" element={<HargaJualSummaryPage />} />
            <Route
