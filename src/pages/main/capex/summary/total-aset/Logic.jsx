...
import { fullNewRow, getRows } from "values/react-grid/rows/summary/capex/template-4/getRows";
import { getColumns } from "values/react-grid/rows/summary/capex/template-4/getColumns";
...
const Logic = () => {
  ...
  const ENDPOINT_URL = "summary_capex/total";
