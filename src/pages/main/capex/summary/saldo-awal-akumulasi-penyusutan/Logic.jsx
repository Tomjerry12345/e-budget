...
import { fullNewRow, getRows } from "values/react-grid/rows/summary/capex/template-3/getRows";
import { getColumns } from "values/react-grid/rows/summary/capex/template-3/getColumns";
...
const Logic = () => {
  ...
  const ENDPOINT_URL = "summary_capex/new_asset/depreciated";
