...
import TransportasiInputLogic from "./TransportasiInputLogic";

const TransportasiInputPage = () => {
  const { value, func } = TransportasiInputLogic();
...
export default TransportasiInputPage;
