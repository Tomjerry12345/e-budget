...
import PerjalananDinasInputLogic from "./PerjalananDinasInputLogic";

const PerjalananDinasInputPage = () => {
  const { value, func } = PerjalananDinasInputLogic();
...
export default PerjalananDinasInputPage;
