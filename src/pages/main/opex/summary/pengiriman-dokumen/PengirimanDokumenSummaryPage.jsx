...
import PengirimanDokumenSummaryLogic from "./PengirimanDokumenSummaryLogic";

const PengirimanDokumenSummaryPage = () => {
  const { value, func } = PengirimanDokumenSummaryLogic();
...
export default PengirimanDokumenSummaryPage;
