...
import FcCetakJilidSummaryLogic from "./FcCetakJilidSummaryLogic";

const FcCetakJilidSummaryPage = () => {
  const { value, func } = FcCetakJilidSummaryLogic();
...
export default FcCetakJilidSummaryPage;
