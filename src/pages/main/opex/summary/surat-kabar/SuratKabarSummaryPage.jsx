...
import SuratKabarSummaryLogic from "./SuratKabarSummaryLogic";

const SuratKabarSummaryPage = () => {
  const { value, func } = SuratKabarSummaryLogic();
...
export default SuratKabarSummaryPage;
