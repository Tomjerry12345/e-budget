...
import TransportasiSummaryLogic from "./TransportasiSummaryLogic";

const TransportasiSummaryPage = () => {
  const { value, func } = TransportasiSummaryLogic();
...
export default TransportasiSummaryPage;
