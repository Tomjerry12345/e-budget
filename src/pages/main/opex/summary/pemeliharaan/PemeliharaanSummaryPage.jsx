...
import PemeliharaanSummaryLogic from "./PemeliharaanSummaryLogic";

const PemeliharaanSummaryPage = () => {
  const { value, func } = PemeliharaanSummaryLogic();
...
export default PemeliharaanSummaryPage;
