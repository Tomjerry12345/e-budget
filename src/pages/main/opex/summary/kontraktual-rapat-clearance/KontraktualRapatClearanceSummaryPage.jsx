...
import KontraktualRapatClearanceSummaryLogic from "./KontraktualRapatClearanceSummaryLogic";

const KontraktualRapatClearanceSummaryPage = () => {
  const { value, func } = KontraktualRapatClearanceSummaryLogic();
...
export default KontraktualRapatClearanceSummaryPage;
