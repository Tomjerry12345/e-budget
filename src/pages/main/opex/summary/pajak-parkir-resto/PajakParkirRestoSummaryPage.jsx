...
import PajakParkirRestoSummaryLogic from "./PajakParkirRestoSummaryLogic";

const PajakParkirRestoSummaryPage = () => {
  const { value, func } = PajakParkirRestoSummaryLogic();
...
export default PajakParkirRestoSummaryPage;
