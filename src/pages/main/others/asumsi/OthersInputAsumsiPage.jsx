...
import OthersInputAsumsiLogic from "./OthersInputAsumsiLogic";
...
const othersInputAsumsiPage = () => {
  const { value, func } = OthersInputAsumsiLogic();
...
export default othersInputAsumsiPage;
