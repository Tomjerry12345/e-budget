...
const PenjualanBandLogic = () => {
  ...
  const getData = async (
    ...
    const url = `band/${endPoint}?code_company=${codeCompany}&code_location=${codeLocation}&code_dept=${codeDept}`;
...
export default PenjualanBandLogic;
