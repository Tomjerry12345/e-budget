...
const PenjualanBsuLogic = () => {
  ...
  const onSetDataTable = async (values) => {
    ...
    setDataColumnInput({
      ...
      [childUrl[1].name]: resListPenjualan,
      [childUrl[2].name]: resListPotongan,
    });
  ...
  const getData = async (
    ...
    const url = `bsu/${endPoint}?code_company=${codeCompany}&code_location=${codeLocation}&code_dept=${codeDept}`;
...
export default PenjualanBsuLogic;
