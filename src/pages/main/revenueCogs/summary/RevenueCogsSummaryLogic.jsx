...
const RevenueCogsSummaryLogic = () => {
  ...
  const onSetDataTable = async (values) => {
    ...
    try {
      const url = `revenueandcogs/summary?code_company=${fCodeCompany}&code_product=${fCodeProduct}&code_location=${fCodeLocation}&code_department=${fCodeDept}&code_icp=${fCodeIcp}&code_project=${fCodeProject}&periode=${fPeriode}`;
