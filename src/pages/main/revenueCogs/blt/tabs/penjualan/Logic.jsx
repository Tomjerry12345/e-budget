        ...
        if (isChange) {
          ...
          if (type === "number") {
            ...
            if (i === 4 || i === 5 || i === 6) {
              ...
              fullRows[7].data[rowIndex].cells[columnIndex].value =
                asumsiTrip * volume * tarif;

              let total1 = 0;
              let total2 = 0;

              const newCellPenjualan = fullRows[7].data[rowIndex].cells.map(
                (e, j) => {
                  if (j >= 2 && j <= 13) total1 += e.value;
                  if (j === 14) e.value = total1;
                  if (j >= 15 && j <= 26) total2 += e.value;
            ...
            if (i === 8) {
              ...
              const vPenjualan =
                fullRows[7].data[rowIndex].cells[indexPenjualan - 1].value;
              ...
              const newCellPotonganPenjualan = fullRows[8].data[
                rowIndex
              ].cells.map((e, j) => {
                if (j >= ind && j <= 24) {
                  total += e.value;
              ...
              fullRows[8].data[length - 1] = updateTotalRow(
                fullRows[8].data,
                item.description
              );
            }
