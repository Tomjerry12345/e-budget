...
const PenjualanKiuLogic = () => {
  ...
  useEffect(() => {
    ...
    log("currentParams", Object.keys(currentParams).length)
  ...
  const getData = async (
    ...
    const url = `kiu/${endPoint}?code_company=${codeCompany}&code_location=${codeLocation}&code_dept=${codeDept}`;
...
export default PenjualanKiuLogic;
