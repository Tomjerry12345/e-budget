...
import HeaderComponentTypeSummaryLabaRugiLogic from "./HeaderComponentTypeSummaryLabaLogic";
...
const HeaderComponentTypeSummaryLabaRugi = ({
  onFinish,
  onChangeFilter,
  onUploadFile,
  downloadFile,
  ...
  const { value, func } = HeaderComponentTypeSummaryLabaRugiLogic({
    onChangeFilter,
    onChangeLoadingUpload,
  });
  return (
...
export default HeaderComponentTypeSummaryLabaRugi;
